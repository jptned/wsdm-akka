...
//import webshop.types.{NotEnoughStockException, StockType, StockTypeKey}
//
...
//
//  val StockKey: ServiceKey[Command] = ServiceKey("stockActor")
//
...
//      context.system.receptionist ! Receptionist.Register(StockKey, context.self)
//
//
